...
int main(int argc, char *argv[]) {
	...
	// In the other case...
		...
		// In the sub-case where the 'argc' variable (which contains the arguments count) is less than 3...
		if(argc < 3) {
			
		}
		
		// In the sub-case where the 'argc' variable (which contains the arguments count) is more than 3...
		if(argc > 3) {
